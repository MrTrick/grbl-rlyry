/*
  defaults_drip.h - defaults settings configuration file
  Part of Grbl-Rlyrly

  Copyright (c) 2016 Patrick Barnes, based on Grbl Copyright (c) 2012-2015 Sungeun K. Jeon
...
#define defaults_h
  ...
  //  - No Z axis, Z settings left as default
  //  - 440mm wide
  //  - 410mm high
  ...
  #define DEFAULT_X_MAX_TRAVEL 440.0 // mm
  #define DEFAULT_Y_MAX_TRAVEL 410.0 // mm
  #define DEFAULT_STEP_PULSE_MICROSECONDS 10
  #define DEFAULT_STEPPING_INVERT_MASK 0
  #define DEFAULT_DIRECTION_INVERT_MASK 0
  #define DEFAULT_STEPPER_IDLE_LOCK_TIME 25 // msec (0-254, 255 keeps steppers enabled)
  #define DEFAULT_STATUS_REPORT_MASK ((BITFLAG_RT_STATUS_MACHINE_POSITION)|(BITFLAG_RT_STATUS_WORK_POSITION)|(BITFLAG_RT_STATUS_RELAY_STATE))
